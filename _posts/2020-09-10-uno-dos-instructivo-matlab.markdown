...
| Expresión Operación | Símbolo en MATLAB - | - | - Poder | ^ | a ^ b | Multiplicación   | *    | a * b | División | / | a / b | Cantidad | + | a + b | Descanso | - | a - b
...
|sind (x) El | Pecho (grados) | ... | ... | - | - | El | … H (x) | función trigonométrica hiperbólica expresa con el ángulo y Radian | sinh (x) | Seno hiperbólico (radianes) | ... | ... | - | - | El | a… (x) | Inverso de la función trigonométrica con el resultado expresado en radianes | asin (x) | Arco mamario (radianes) | ... | ... | - | - | El | a… d (x) |
  ...
  Inversa de la función trigonométrica con el resultado expresado en grados
